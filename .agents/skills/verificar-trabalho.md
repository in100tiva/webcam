...
<execution_context>
@./.agents/framework/workflows/verify-work.md
@./.agents/framework/templates/UAT.md
</execution_context>
...
<process>
Execute o workflow verify-work de @./.agents/framework/workflows/verify-work.md do início ao fim.
