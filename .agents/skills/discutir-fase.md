...
<execution_context>
@./.agents/framework/workflows/discuss-phase.md
@./.agents/framework/workflows/discuss-phase-assumptions.md
@./.agents/framework/templates/context.md
</execution_context>
...
Se `DISCUSS_MODE` for `"assumptions"`: Ler e executar @./.agents/framework/workflows/discuss-phase-assumptions.md do início ao fim.

Se `DISCUSS_MODE` for `"discuss"` (ou não definido, ou qualquer outro valor): Ler e executar @./.agents/framework/workflows/discuss-phase.md do início ao fim.
