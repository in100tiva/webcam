...
<execution_context>
@./.agents/framework/workflows/plan-milestone-gaps.md
</execution_context>
...
<process>
Execute o workflow plan-milestone-gaps de @./.agents/framework/workflows/plan-milestone-gaps.md do início ao fim.
