...
> Referenciado por agentes via `@./.agents/framework/references/output-style.md`. Agentes herdam essas regras automaticamente — não duplique o conteúdo no agente.
