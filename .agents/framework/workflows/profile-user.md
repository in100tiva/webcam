...
- @./.agents/framework/references/ui-brand.md (padrões de exibição)
- @./.agents/framework/agents/user-profiler.md (definição do agente de perfilamento)
- @./.agents/framework/references/user-profiling.md (documento de referência de perfilamento)
</required_reading>
...
Reference: @./.agents/framework/references/user-profiling.md
